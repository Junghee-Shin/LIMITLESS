 ...
 *
 */
public class RecipeDetailFXController implements Initializable {
	@FXML	Button 	homeBtn;
	@FXML	Button  backBtn;
	@FXML 	Label	reName;
	@FXML 	Label	reFood;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		RecipeDetailInfoVO re = new RecipeDetailInfoVO(HRConst.recipeDetailTmp.getReNo(),"","","","","","","");
		...
		recipe= HRConst.recipeDetailTmp.getReNo();
		
		System.out.println("id:"+id+" // recipeNo:"+recipe);
